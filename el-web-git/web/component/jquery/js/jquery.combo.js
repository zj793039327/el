	...
	$.Combo.prototype = {
		...
		*/
		_setListLayout: function(){
			...
			if (opts.width == 'auto') {
				var comboW = this.listWrap.outerWidth() + Math.max(triggerW,diffW) + opts.adjustWidth;
